...
- I'm doing this project to learn more about CI/CD and get hands on experience in automating the flow
from  developing code to deployed web app.
- This project fits the role of a solutions architect, which is a certificate I hold in associate level.
- This fits into my career goals because I want to become a solutions architect this year.
...
- Key pairs, SSH connections, installed Git, Maven and Java.
...
Siphosethu - [email@example.com](mailto:bump@email.com)
